...
function makeUpdateFieldInputTypeFields({ relationshipAdapter, composer, userDefinedFieldDirectives, ifUnionMemberEntity, features, }) {
    ...
    if ((0, utils_1.shouldAddDeprecatedFields)(features, "nonNestedUpdateWhere")) {
        if (connectionWhereInputType) {
            fields["where"] = {
                type: connectionWhereInputType,
                directives: [(0, constants_2.DEPRECATE_UPDATE_WHERE)(relationshipAdapter, ifUnionMemberEntity)],
            };
        }
    }
    ...
    const connectFieldInputType = (0, connect_input_1.withConnectFieldInputType)({
        relationshipAdapter,
        ifUnionMemberEntity,
        composer,
        features,
