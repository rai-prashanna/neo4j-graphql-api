...
function augmentConnectInputTypeWithConnectFieldInput({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
...
function makeConnectInputType({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
...
function withUnionConnectInputType({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
...
function makeUnionConnectInputTypeFields({ relationshipAdapter, composer, deprecatedDirectives, features, }) {
    const fields = {};
    if (!(relationshipAdapter.target instanceof UnionEntityAdapter_1.UnionEntityAdapter)) {
...
function withConnectFieldInputType({ relationshipAdapter, composer, ifUnionMemberEntity, features, }) {
...
function makeConnectFieldInputTypeFields({ relationshipAdapter, composer, ifUnionMemberEntity, features, }) {
    const fields = {};
    ...
    if (relationshipAdapter.target instanceof ConcreteEntityAdapter_1.ConcreteEntityAdapter) {
        ...
        if ((0, utils_1.shouldAddDeprecatedFields)(features, "overwriteArgument")) {
