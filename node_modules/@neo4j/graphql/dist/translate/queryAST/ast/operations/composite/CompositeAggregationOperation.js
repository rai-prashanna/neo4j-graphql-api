...
class CompositeAggregationOperation extends operations_1.Operation {
    constructor({ compositeEntity, children, directed = true, }) {
        ...
        this.isInConnectionField = false; // Used for compatibility with deprecated aggregations, this will always be true in 7.x
        ...
        if (parentNode) {
            ...
            if (!this.isInConnectionField) {
                ...
                subqueriesAggr = result.clauses.map((clause) => {
                    return new cypher_builder_1.default.Call(clause);
                });
            }
            else {
