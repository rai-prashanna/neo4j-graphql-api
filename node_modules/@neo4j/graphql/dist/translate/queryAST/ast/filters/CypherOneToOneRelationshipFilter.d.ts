...
export declare class CypherOneToOneRelationshipFilter extends Filter {
    ...
    private isNot;
    private isNull;
    constructor({ selection, attribute, operator, isNot, isNull, returnVariable, }: {
...
//# sourceMappingURL=CypherOneToOneRelationshipFilter.d.ts.map