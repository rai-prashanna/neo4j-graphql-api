...
exports.CypherRelationshipFilter = void 0;
const cypher_builder_1 = __importDefault(require("@neo4j/cypher-builder"));
const Filter_1 = require("./Filter");
class CypherRelationshipFilter extends Filter_1.Filter {
    ...
    getSubqueries(context) {
        ...
        const cypherSubquery = selection.return([cypher_builder_1.default.collect(nestedContext.returnVariable), this.returnVariable]);
    ...
    createRelationshipOperation(queryASTContext) {
        const x = new cypher_builder_1.default.Node();
        ...
        switch (this.operator) {
            case "ALL": {
                return cypher_builder_1.default.all(x, this.returnVariable, innerPredicate);
            }
            case "SINGLE": {
                return cypher_builder_1.default.single(x, this.returnVariable, innerPredicate);
            }
            case "NONE": {
                return cypher_builder_1.default.none(x, this.returnVariable, innerPredicate);
            }
            case "SOME": {
                return cypher_builder_1.default.any(x, this.returnVariable, innerPredicate);
            }
        }
    }
...
exports.CypherRelationshipFilter = CypherRelationshipFilter;
//# sourceMappingURL=CypherRelationshipFilter.js.map